...
# October Bus isn't bundled: the engine downloads a pinned, signed build the first time it's
# needed (scripts/build-bus.sh, scripts/publish-bus.sh, engine/bus.json).
